...
You can access the live version of the Wakanda Staking platform here:

https://wakanda-staking.vercel.app/

How to interact:

- Make sure your wallet is connected to the Polygon Amoy Testnet.

- Ensure you have some test tokens to interact with the staking and governance functions.

- Use the dashboard to track your balances and pending rewards in real-time.
